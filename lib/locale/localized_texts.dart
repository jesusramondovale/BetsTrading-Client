...
class LocalizedStrings {
  ...
  static final Map<String?, Map<String?, String?>> localizedValues = {
    'en': {
      ...
      'cv_chart_body': 'Drag with one finger to pan. Pinch horizontally to zoom; slide vertically over the right price axis for vertical zoom. Long press a candle to see OHLC details. Dashed bet zones allow bounces inside but not breaks; solid zones require every price to stay within to win.',
      'cv_back_title': 'Back',
    ...
    'es': {
      ...
      'cv_chart_body': 'Arrastra con un dedo para mover. Pellizca horizontalmente para zoom; desliza verticalmente sobre la columna de precios derecha para zoom vertical. Mantén pulsado sobre una vela para ver detalles OHLC. Las zonas de apuesta discontinuas permiten rebotes sin romper; las continuas exigen que todo el precio permanezca dentro para ganar.',
    ...
    'fr': {
      ...
      'cv_chart_body': 'Glissez avec un doigt pour déplacer. Pincez horizontalement pour zoomer ; faites glisser verticalement sur l’axe des prix à droite pour un zoom vertical. Appui long sur une bougie pour voir les détails OHLC. Les zones en pointillé autorisent les rebonds sans rupture ; les pleines exigent que le cours reste entièrement à l’intérieur pour gagner.',
    ...
    'it': {
      ...
      'cv_chart_body': 'Trascina con un dito per spostare. Pizzica orizzontalmente per lo zoom; scorri verticalmente sull’asse prezzi a destra per lo zoom verticale. Pressione prolungata su una candela per i dettagli OHLC. Le zone tratteggiate consentono rimbalzi senza rotture; quelle continue richiedono che il prezzo resti sempre dentro per vincere.',
    ...
    'de': {
      ...
      'cv_chart_title': 'Chart',
      'cv_chart_body': 'Mit einem Finger ziehen zum Verschieben. Horizontales Zusammenziehen zum Zoomen; vertikal über der rechten Preisachse wischen für vertikales Zoom. Langes Drücken auf eine Kerze zeigt OHLC-Details. Gestrichelte Zonen erlauben Abpraller ohne Durchbruch; durchgehende Zonen verlangen, dass der Preis komplett innen bleibt, um zu gewinnen.',
