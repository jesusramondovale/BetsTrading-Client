...
class LocalizedStrings {
  ...
  static final Map<String?, Map<String?, String?>> localizedValues = {
    'en': {
      ...
      'cv_zone_types_title': 'Bet zone types',
      'cv_zone_types_body': 'Each zone type has a different rule. Learn them before placing bets.',
      'cv_zone_standard_title': 'Standard zone',
      'cv_zone_standard_body': 'You win only if price stays inside the zone during the whole time window.',
      'cv_zone_extreme_title': 'Extreme zone',
      'cv_zone_extreme_body': 'You win if price touches the zone at least once, even if it stays outside the rest of the time.',
      'cv_zone_limit_title': 'Limit zone',
      'cv_zone_limit_body': 'You win if price touches the zone but never breaks the continuous limit side.',
      ...
      'raffleAlreadyParticipated': 'You have already joined this raffle',
      ...
      'betLost': 'Bet lost',
      'history': 'History',
      'copyBettingButton': 'Copy-Betting',
      'copyBettingProfileTitle': 'Copy-Betting',
      'copyBettingPerformanceSection': 'Performance',
      'copyBettingFinishedBetsCount': 'Finished bets',
      'copyBettingTotalStaked': 'Total staked',
      'copyBettingTotalProfitLoss': 'PnL',
      'copyBettingWinRate': 'Win rate',
      'copyBettingWins': 'Wins',
      'copyBettingLosses': 'Losses',
      'copyBettingRecentSection': 'Last bets',
      'copyBettingNoRecentBets': 'No recent bets to show for this user.',
      'copyBettingLoadError': 'Could not load this profile.',
      'copyBettingNoStatsHint': 'Statistics use finished zone bets from history.',
      'copyBettingConfirmCopyTradingButton': 'Confirm copy-trading',
      'copyTradingConfirmTitle': 'Confirm copy-trading',
      'copyTradingConfirmPlaceholder':
          'Here you will confirm copy-trading in a future update. This screen is under development.',
      'copyBettingPercentageTitle': 'Copy percentage',
      'copyBettingAutoModeDescription':
          'Auto mode uses both balances so copied bets keep the same proportional risk.',
      'copyBettingAutoAdjustTitle': 'Adjust percentage automatically by balances',
      'copyBettingStopAfterLossTitle': 'Stop copying automatically after 1 failed bet',
      'copyBettingAutoPreview':
          'Example: if {target} has {targetCoins} and bets {targetBet}, you would bet {copiedBet}.',
      'copyBettingConfigured': 'Copy-betting configured successfully',
      'copyBettingCancelCopyTradingButton': 'Cancel copy-trading',
      'copyTradingCancelTitle': 'Cancel copy-trading',
      'copyBettingCopyTradingCancelled': 'Copy-trading cancelled',
      'cancelCopyTrading': 'Slide to cancel copy-trading',
      'hours': 'Hour/s',
      'send': 'Send',
      ...
      'deleted': 'Deleted',
      'error': 'Error',
      'oopsError': 'Oops.. error',
      'modoPrivado': 'Private mode',
      'modoPublico': 'Public mode',
      'privateModeLeaderboardMessage': 'When you use private mode, other users will not be able to see your real name on the leaderboards; your username will be shown instead.',
      'publicModeLeaderboardMessage': 'When you use public mode, other users will be able to see your real name on the leaderboards.',
      'sessionRequired': 'Session required',
      'couldNotUpdatePrivateMode': 'Could not update private mode.',
      'saved': 'Saved',
      'delete': 'Delete',
      ...
      'maintenanceLogout': 'Servers under maintenance. Sorry for the inconvenience.',
      ...
      'noAdsPurchaseThanks': 'Thank you. Ads have been disabled.',
      'noAdsPackLabel': 'No Ads',
      ...
      'enableBiometricAuth': 'Enable biometrics',
      'biometricUnavailableTitle': 'Biometrics unavailable',
      'biometricUnavailableBody': 'Your device does not have biometric authentication configured.',
      'biometricAuthReason': 'Authenticate to continue',
      ...
      'notifyProblem': 'Report a problem',
      'versionCode': 'Version code: ',
      'close': 'Close',
      'current': 'Current',
      'updatedFavs': 'Updated favorites!',
      'noFavsYet': 'You have no favorites yet. Add one from Best odds, or by long-pressing on the Markets tab.',
    ...
    'es': {
      ...
      'cv_zone_types_title': 'Tipos de zonas de apuesta',
      'cv_zone_types_body': 'Cada tipo de zona tiene una regla distinta. Revísalas antes de apostar.',
      'cv_zone_standard_title': 'Zona estándar',
      'cv_zone_standard_body': 'Ganas solo si el precio se mantiene dentro de la zona durante toda la ventana temporal.',
      'cv_zone_extreme_title': 'Zona extrema',
      'cv_zone_extreme_body': 'Ganas si el precio toca la zona al menos una vez, aunque el resto del tiempo esté fuera.',
      'cv_zone_limit_title': 'Zona límite',
      'cv_zone_limit_body': 'Ganas si el precio toca la zona, pero no rompe el lado continuo del límite.',
      ...
      'raffleAlreadyParticipated': 'Ya participaste en este sorteo',
      ...
      'copyBettingButton': 'Copy-Betting',
      'copyBettingProfileTitle': 'Copy-Betting',
      'copyBettingPerformanceSection': 'Rendimiento',
      'copyBettingFinishedBetsCount': 'Apuestas finalizadas',
      'copyBettingTotalStaked': 'Total apostado',
      'copyBettingTotalProfitLoss': 'PnL',
      'copyBettingWinRate': 'Tasa de acierto',
      'copyBettingWins': 'Ganadas',
      'copyBettingLosses': 'Pérdidas',
      'copyBettingRecentSection': 'Últimas apuestas',
      'copyBettingNoRecentBets': 'No hay apuestas recientes que mostrar para este usuario.',
      'copyBettingLoadError': 'No se pudo cargar este perfil.',
      'copyBettingNoStatsHint': 'Las estadísticas usan apuestas de zona finalizadas del historial.',
      'copyBettingConfirmCopyTradingButton': 'Confirmar copy-trading',
      'copyTradingConfirmTitle': 'Confirmar copy-trading',
      'copyTradingConfirmPlaceholder':
          'Aquí podrás confirmar el copy-trading en una próxima actualización. Pantalla en desarrollo.',
      'copyBettingPercentageTitle': 'Porcentaje de copia',
      'copyBettingAutoModeDescription':
          'El modo automático usa ambos balances para mantener el mismo riesgo proporcional.',
      'copyBettingAutoAdjustTitle':
          'Ajustar automáticamente el porcentaje según los balances',
      'copyBettingStopAfterLossTitle':
          'Dejar de copiar automáticamente tras 1 apuesta fallada',
      'copyBettingAutoPreview':
          'Ejemplo: si {target} tiene {targetCoins} y apuesta {targetBet}, tú apostarías {copiedBet}.',
      'copyBettingConfigured': 'Copy-betting configurado correctamente',
      'copyBettingCancelCopyTradingButton': 'Cancelar copy-trading',
      'copyTradingCancelTitle': 'Cancelar copy-trading',
      'copyBettingCopyTradingCancelled': 'Copy-trading cancelado',
      'cancelCopyTrading': 'Desliza para cancelar el copy-trading',
      'hours': 'Hora/s',
      'send': 'Enviar',
      ...
      'modoPublico': 'Modo público',
      'privateModeLeaderboardMessage': 'Cuando uses modo privado, el resto de usuarios no podrá ver tu nombre real en las listas de clasificaciones; se mostrará tu nombre de usuario.',
      'publicModeLeaderboardMessage': 'Cuando uses modo público, el resto de usuarios podrá ver tu nombre real en las listas de clasificaciones.',
      'sessionRequired': 'Sesión requerida',
      'couldNotUpdatePrivateMode': 'No se pudo actualizar el modo privado.',
      'saved': 'Guardado',
      'delete': 'Eliminar',
      ...
      'maintenanceLogout': 'Servidores en mantenimiento. Disculpe las molestias.',
      ...
      'noAdsPurchaseThanks': 'Gracias. Los anuncios han sido desactivados',
      'noAdsPackLabel': 'Sin anuncios',
      ...
      'enableBiometricAuth': 'Activar biometría',
      'biometricUnavailableTitle': 'Biometría no disponible',
      'biometricUnavailableBody': 'Tu dispositivo no tiene autenticación biométrica configurada.',
      'biometricAuthReason': 'Autentícate para continuar',
      ...
      'notifyProblem': 'Notificar un problema',
      'versionCode': 'Versión de código: ',
      'close': 'Cierre',
      'current': 'Actual',
      'updatedFavs': 'Favoritos actualizados!',
      'noFavsYet': 'No tienes favoritos, añade uno desde Mejores cuotas o manteniendo pulsado en la pestaña de Mercados.',
    ...
    'fr': {
      ...
      'cv_zone_types_title': 'Types de zones de pari',
      'cv_zone_types_body': 'Chaque type de zone suit une règle différente. Vérifiez-les avant de parier.',
      'cv_zone_standard_title': 'Zone standard',
      'cv_zone_standard_body': 'Vous gagnez seulement si le prix reste dans la zone pendant toute la fenêtre temporelle.',
      'cv_zone_extreme_title': 'Zone extrême',
      'cv_zone_extreme_body': 'Vous gagnez si le prix touche la zone au moins une fois, même s’il reste dehors le reste du temps.',
      'cv_zone_limit_title': 'Zone limite',
      'cv_zone_limit_body': 'Vous gagnez si le prix touche la zone sans franchir le côté limite en trait continu.',
      ...
      'raffleAlreadyParticipated': 'Vous avez déjà participé à ce tirage',
      'participants': 'Participants:',
      ...
      'copyBettingProfileTitle': 'Copy-Betting',
      'copyBettingPerformanceSection': 'Performance',
      'copyBettingFinishedBetsCount': 'Paris terminés',
      'copyBettingTotalStaked': 'Total misé',
      'copyBettingTotalProfitLoss': 'PnL',
      'copyBettingWinRate': 'Taux de réussite',
      'copyBettingWins': 'Gagnés',
      'copyBettingLosses': 'Perdus',
      'copyBettingRecentSection': 'Derniers paris',
      'copyBettingNoRecentBets': 'Aucun pari récent à afficher pour cet utilisateur.',
      'copyBettingLoadError': 'Impossible de charger ce profil.',
      'copyBettingNoStatsHint': 'Les statistiques utilisent les paris de zone terminés de l’historique.',
      'copyBettingConfirmCopyTradingButton': 'Confirmer le copy-trading',
      'copyTradingConfirmTitle': 'Confirmer le copy-trading',
      'copyTradingConfirmPlaceholder':
          'Vous pourrez confirmer le copy-trading ici dans une prochaine mise à jour. Écran en cours de développement.',
      'copyBettingCancelCopyTradingButton': 'Annuler le copy-trading',
      'copyTradingCancelTitle': 'Annuler le copy-trading',
      'copyBettingCopyTradingCancelled': 'Copy-trading annulé',
      'cancelCopyTrading': 'Glissez pour annuler le copy-trading',
      'hours': 'Heure/s',
      'send': 'Envoyer',
      ...
      'deleted': 'Supprimé',
      'error': 'Erreur',
      'oopsError': 'Oups.. erreur',
      'modoPrivado': 'Mode privé',
      'modoPublico': 'Mode public',
      'privateModeLeaderboardMessage': 'En mode privé, les autres utilisateurs ne pourront pas voir votre nom réel dans les classements ; votre nom d\'utilisateur sera affiché à la place.',
      'publicModeLeaderboardMessage': 'En mode public, les autres utilisateurs pourront voir votre nom réel dans les classements.',
      'sessionRequired': 'Session requise',
      'couldNotUpdatePrivateMode': 'Impossible de mettre à jour le mode privé.',
      'saved': 'Enregistré',
      'delete': 'Supprimer',
      ...
      'maintenanceLogout': 'Serveurs en maintenance. Veuillez nous excuser pour la gêne occasionnée.',
      ...
      'noAdsPurchaseThanks': 'Merci. Les publicités ont été désactivées.',
      'noAdsPackLabel': 'Sans pubs',
      ...
      'enableBiometricAuth': 'Activer la biométrie',
      'biometricUnavailableTitle': 'Biométrie indisponible',
      'biometricUnavailableBody': 'Votre appareil ne dispose pas d’authentification biométrique configurée.',
      'biometricAuthReason': 'Authentifiez-vous pour continuer',
      ...
      'notifyProblem': 'Signaler un problème',
      'versionCode': 'Code de version : ',
      'close': 'Clôture',
      'current': 'Actuel',
      'updatedFavs': 'Favoris mis à jour',
      'noFavsYet': 'Vous n’avez pas encore de favoris. Ajoutez-en depuis Meilleures cotes ou en maintenant appuyé sur l’onglet Marchés.',
      ...
      'aboveShort': 'Au-dessus',
      'belowShort': 'En dessous',
      'from': 'DEPUIS',
      'until': 'JUSQU\'À',
    ...
    'it': {
      ...
      'cv_zone_types_title': 'Tipi di zone di scommessa',
      'cv_zone_types_body': 'Ogni tipo di zona ha una regola diversa. Leggile prima di scommettere.',
      'cv_zone_standard_title': 'Zona standard',
      'cv_zone_standard_body': 'Vinci solo se il prezzo rimane dentro la zona per tutta la finestra temporale.',
      'cv_zone_extreme_title': 'Zona estrema',
      'cv_zone_extreme_body': 'Vinci se il prezzo tocca la zona almeno una volta, anche se resta fuori per il resto del tempo.',
      'cv_zone_limit_title': 'Zona limite',
      'cv_zone_limit_body': 'Vinci se il prezzo tocca la zona ma non supera il lato limite continuo.',
      ...
      'raffleAlreadyParticipated': 'Hai già partecipato a questo sorteggio',
      ...
      'copyBettingButton': 'Copy-Betting',
      'copyBettingProfileTitle': 'Copy-Betting',
      'copyBettingPerformanceSection': 'Rendimento',
      'copyBettingFinishedBetsCount': 'Scommesse concluse',
      'copyBettingTotalStaked': 'Totale giocato',
      'copyBettingTotalProfitLoss': 'PnL',
      'copyBettingWinRate': 'Tasso di vincita',
      'copyBettingWins': 'Vinte',
      'copyBettingLosses': 'Perse',
      'copyBettingRecentSection': 'Ultime scommesse',
      'copyBettingNoRecentBets': 'Nessuna scommessa recente da mostrare per questo utente.',
      'copyBettingLoadError': 'Impossibile caricare questo profilo.',
      'copyBettingNoStatsHint': 'Le statistiche usano le scommesse a zona concluse dalla cronologia.',
      'copyBettingConfirmCopyTradingButton': 'Conferma copy-trading',
      'copyTradingConfirmTitle': 'Conferma copy-trading',
      'copyTradingConfirmPlaceholder':
          'Potrai confermare il copy-trading qui in un aggiornamento futuro. Schermata in sviluppo.',
      'copyBettingCancelCopyTradingButton': 'Annulla copy-trading',
      'copyTradingCancelTitle': 'Annulla copy-trading',
      'copyBettingCopyTradingCancelled': 'Copy-trading annullato',
      'cancelCopyTrading': 'Scorri per annullare il copy-trading',
      'hours': 'Ora/e',
      'send': 'Invia',
      ...
      'deleted': 'Eliminato',
      'error': 'Errore',
      'oopsError': 'Ops.. errore',
      'modoPrivado': 'Modalità privata',
      'modoPublico': 'Modalità pubblica',
      'privateModeLeaderboardMessage': 'In modalità privata, gli altri utenti non potranno vedere il tuo nome reale nelle classifiche; verrà mostrato il tuo nome utente.',
      'publicModeLeaderboardMessage': 'In modalità pubblica, gli altri utenti potranno vedere il tuo nome reale nelle classifiche.',
      'sessionRequired': 'Sessione richiesta',
      'couldNotUpdatePrivateMode': 'Impossibile aggiornare la modalità privata.',
      'saved': 'Salvato',
      'delete': 'Elimina',
      ...
      'maintenanceLogout': 'Server in manutenzione. Ci scusiamo per il disagio.',
      ...
      'noAdsPurchaseThanks': 'Grazie. Le pubblicità sono state disattivate.',
      'noAdsPackLabel': 'No pubblicità',
      ...
      'enableBiometricAuth': 'Attiva biometria',
      'biometricUnavailableTitle': 'Biometria non disponibile',
      'biometricUnavailableBody': 'Il tuo dispositivo non ha l’autenticazione biometrica configurata.',
      'biometricAuthReason': 'Autenticati per continuare',
      ...
      'aboutUs': 'Chi siamo',
      'notifyProblem': 'Segnala un problema',
      'versionCode': 'Codice versione: ',
      'close': 'Chiusura',
      'current': 'Attuale',
      'updatedFavs': 'Preferiti aggiornati',
      'noFavsYet': 'Non hai ancora preferiti. Aggiungine uno da Migliori quote o tenendo premuta la scheda Mercati.',
    ...
    'de': {
      ...
      'cv_zone_types_title': 'Arten von Wettzonen',
      'cv_zone_types_body': 'Jeder Zonentyp hat eigene Regeln. Prüfe sie vor dem Platzieren einer Wette.',
      'cv_zone_standard_title': 'Standardzone',
      'cv_zone_standard_body': 'Du gewinnst nur, wenn der Preis während des gesamten Zeitfensters in der Zone bleibt.',
      'cv_zone_extreme_title': 'Extreme Zone',
      'cv_zone_extreme_body': 'Du gewinnst, wenn der Preis die Zone mindestens einmal berührt, auch wenn er sonst außerhalb bleibt.',
      'cv_zone_limit_title': 'Grenzzone',
      'cv_zone_limit_body': 'Du gewinnst, wenn der Preis die Zone berührt, aber die durchgehende Grenzseite nie überschreitet.',
      ...
      'raffleAlreadyParticipated': 'Du nimmst an dieser Verlosung bereits teil',
      ...
      'copyBettingButton': 'Copy-Betting',
      'copyBettingProfileTitle': 'Copy-Betting',
      'copyBettingPerformanceSection': 'Rendite',
      'copyBettingFinishedBetsCount': 'Abgeschlossene Wetten',
      'copyBettingTotalStaked': 'Gesamteinsatz',
      'copyBettingTotalProfitLoss': 'PnL',
      'copyBettingWinRate': 'Trefferquote',
      'copyBettingWins': 'Gewonnen',
      'copyBettingLosses': 'Verloren',
      'copyBettingRecentSection': 'Letzte Wetten',
      'copyBettingNoRecentBets': 'Keine aktuellen Wetten für diesen Nutzer.',
      'copyBettingLoadError': 'Profil konnte nicht geladen werden.',
      'copyBettingNoStatsHint': 'Die Statistik nutzt abgeschlossene Zonenwetten aus dem Verlauf.',
      'copyBettingConfirmCopyTradingButton': 'Copy-Trading bestätigen',
      'copyTradingConfirmTitle': 'Copy-Trading bestätigen',
      'copyTradingConfirmPlaceholder':
          'Hier kannst du Copy-Trading in einem künftigen Update bestätigen. Diese Ansicht ist in Arbeit.',
      'copyBettingCancelCopyTradingButton': 'Copy-Trading abbrechen',
      'copyTradingCancelTitle': 'Copy-Trading abbrechen',
      'copyBettingCopyTradingCancelled': 'Copy-Trading abgebrochen',
      'cancelCopyTrading': 'Zum Abbrechen des Copy-Tradings wischen',
      'hours': 'Stunde/n',
      'send': 'Senden',
      ...
      'deleted': 'Gelöscht',
      'error': 'Fehler',
      'oopsError': 'Hoppla.. Fehler',
      'modoPrivado': 'Privater Modus',
      'modoPublico': 'Öffentlicher Modus',
      'privateModeLeaderboardMessage': 'Im privaten Modus können andere Nutzer deinen echten Namen in den Bestenlisten nicht sehen; stattdessen wird dein Benutzername angezeigt.',
      'publicModeLeaderboardMessage': 'Im öffentlichen Modus können andere Nutzer deinen echten Namen in den Bestenlisten sehen.',
      'sessionRequired': 'Sitzung erforderlich',
      'couldNotUpdatePrivateMode': 'Privaten Modus konnte nicht aktualisiert werden.',
      'saved': 'Gespeichert',
      'delete': 'Löschen',
      ...
      'maintenanceLogout': 'Server in Wartung. Entschuldigen Sie die Unannehmlichkeiten.',
      ...
      'noAdsPurchaseThanks': 'Danke. Die Werbung wurde deaktiviert.',
      'noAdsPackLabel': 'Ohne Werbung',
      ...
      'enableBiometricAuth': 'Biometrie aktivieren',
      'biometricUnavailableTitle': 'Biometrie nicht verfügbar',
      'biometricUnavailableBody': 'Auf deinem Gerät ist keine biometrische Authentifizierung eingerichtet.',
      'biometricAuthReason': 'Zur Fortsetzung authentifizieren',
      ...
      'aboutUs': 'Über uns',
      'notifyProblem': 'Problem melden',
      'versionCode': 'Version code: ',
      'close': 'Schlusskurs',
      'current': 'Aktuell',
      'updatedFavs': 'Favoriten aktualisiert',
      'noFavsYet': 'Du hast noch keine Favoriten. Füge einen über Beste Quoten hinzu oder durch langes Drücken auf den Reiter Märkte.',
